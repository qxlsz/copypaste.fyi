...
export const DashboardPage = () => {
  ...
  const keyFingerprint = user
    ? btoa(user.pubkey).slice(0, 32).toUpperCase()
    : "";
              ...
              <div className="bg-white dark:bg-slate-800 shadow overflow-hidden sm:rounded-md border border-gray-200 dark:border-slate-700">
                ...
                <dl className="sm:divide-y sm:divide-gray-200 dark:sm:divide-slate-700">
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-green-600 dark:text-green-400 sm:mt-0 sm:col-span-2 font-mono font-semibold">
                      {keyAlgorithm}
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-blue-600 dark:text-blue-400 sm:mt-0 sm:col-span-2 font-mono">
                      {keyStrength}
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-purple-600 dark:text-purple-400 sm:mt-0 sm:col-span-2 font-mono break-all">
                      {keyFingerprint}
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-orange-600 dark:text-orange-400 sm:mt-0 sm:col-span-2 font-mono">
                      {gpgKeyId}
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-cyan-600 dark:text-cyan-400 sm:mt-0 sm:col-span-2">
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-indigo-600 dark:text-indigo-400 sm:mt-0 sm:col-span-2 font-mono">
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-pink-600 dark:text-pink-400 sm:mt-0 sm:col-span-2">
                      RFC 8032 Ed25519
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-teal-600 dark:text-teal-400 sm:mt-0 sm:col-span-2">
              ...
              <div className="bg-white dark:bg-slate-800 shadow overflow-hidden sm:rounded-md border border-gray-200 dark:border-slate-700">
                  ...
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white flex items-center">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4M6 16l-4-4 4-4"
                      />
                    </svg>
                ...
                <dl className="sm:divide-y sm:divide-gray-200 dark:sm:divide-slate-700">
                  <div className="py-4 sm:py-5 sm:px-6">
                    ...
                    <dd className="text-xs text-gray-900 dark:text-white font-mono break-all bg-gray-50 dark:bg-slate-900 p-3 rounded border">
                      {user.pubkey}
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:px-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      >
                        <svg
                          className={`h-3 w-3 mr-1 transition-transform ${showPrivateKey ? "rotate-180" : ""}`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                    ...
                    {showPrivateKey && (
                      <dd className="text-xs text-gray-900 dark:text-white font-mono break-all bg-red-50 dark:bg-red-900/20 p-3 rounded border border-red-200 dark:border-red-800">
                        <div className="text-red-600 dark:text-red-400 text-xs mb-1 font-semibold">

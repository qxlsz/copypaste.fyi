...
export const PrivacyJourney = () => {
  ...
  return (
    <div className="pointer-events-none fixed bottom-4 left-4 z-50 hidden sm:pointer-events-auto sm:bottom-6 sm:left-[4.5rem] sm:block">
      <button
        onClick={() => setIsExpanded(!isExpanded)}
        aria-expanded={isExpanded}
        aria-label="Privacy journey details"
        className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-border bg-surface px-2.5 py-1 font-mono text-[11px] text-muted-foreground transition hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
